...
Choosing "选中原文" in the composer also captures the passage before typing.
...
highlight creation, both selection-question entry paths, and the selected passage
actually sent in the question.
