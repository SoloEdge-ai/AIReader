...
- Node v24.19.0 执行 `vitest run`：49 个文件、94 项测试通过，覆盖 Core HTTP、SQLite、PDF 提取、来源冻结、笔记、书籍级命令、主题组、归档、AI 材料和几何。
- Node v24.19.0 执行 Playwright 阅读 UI 套件：45 项通过。包括双视口、窄窗、四套外观、摘录与拖放、分组、比较、原文聚焦、笔记与多来源、AI 材料状态、输入焦点、长 PDF 第 300 页重开及保存失败恢复。
