import type { WorkspaceObject, SurfaceAnchor, InkStroke } from "../../protocol/src/workspace";
import type { WorkspacePage } from "./surfaces";
import { projectStroke, splitStroke, type InkPoint } from "./ink";
...
export function newShape(id: string, kind: Extract<WorkspaceObject, { kind: "shape" }>["shape"],
  ...
  return {
    id, kind: "shape", shape: kind, surface: at.surface,
